...
class SearchVideoScreen extends GetView<SearchVideoController> {
  @override
...
class VideoListSearch extends GetView<SearchVideoController> {
  const VideoListSearch({Key? key}) : super(key: key);
