...
class HeaderView extends GetView<NewsController>{
  ...
  Widget build(BuildContext context) {
    return Obx(() =>  GestureDetector(
      onTap: (){
        Get.toNamed(AppConst.DETAIL_NEWS,arguments: [controller.data.value]);
      },
      child: Container(
                ...
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(controller.data.value.title??"",
                      style: const TextStyle(fontSize: 16,color: Colors.white,fontWeight: FontWeight.w700,fontFamily: "montserrat_black"),
            ...
            Positioned(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: Text("${DateFormat("dd/MM/yyyy").format(DateTime.parse((controller.data.value.createdDate ?? "2022-11-01T100:00:00").split("T").first))} - ${controller.data.value.views ?? 0} lượt xem",
                      style: const TextStyle(fontSize: 12,color: Colors.white70,fontWeight: FontWeight.w400,fontFamily: "montserrat_black"),
                    ),
                  ),
                )
            )
  ...
  Widget buildImageHeader(){
    return ClipRRect(
      ...
      child: CachedNetworkImage(
          ...
          placeholder: (context, url) => Image.asset("assets/images/loading.gif",fit: BoxFit.cover,width: Get.width,),
    ...
    return Obx(() => GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return GestureDetector(
            onTap: (){
              Get.toNamed(AppConst.DETAIL_NEWS,arguments: [controller.list.elementAt(index)]);
            },
            child: Container(
                margin: index.isEven
                    ...
                    children: [
                      SizedBox(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(12),
                            child: CachedNetworkImage(
                                imageUrl:  controller.list.elementAt(index).thumbnail??"",
                                imageBuilder: (context, imageProvider) => Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: imageProvider,
                      ...
                      SizedBox(
                        ...
                        Text(
                          ...
                          style: const TextStyle(fontSize: 10,fontFamily: "montserrat_black",fontWeight: FontWeight.w400),
                        ),
                      ),
